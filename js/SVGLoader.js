...
THREE.SVGLoader.prototype = {
	...
	parse: function ( text ) {
		...
		*/
		...
		// Custom ShapePath to holding depth and text.
        function ShapePath(node){
            THREE.ShapePath.call(this);
            this.node = node;
			this.depth = function () {
				return depth;
            }
			...
			function loadDepth() {
				if (node == null || !node.hasAttribute("depth")) {
					return 1
				}
				return parseFloats(node.getAttribute("depth"));
            }
        ...
        ShapePath.prototype = new THREE.ShapePath();
